...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  final ScrollController _page2Scroll = ScrollController();
  final ScrollController _page3Scroll = ScrollController();
  ...
  void dispose() {
    ...
    _page2Scroll.dispose();
    _page3Scroll.dispose();
  ...
  List<Map<String, String>> _buildEmploymentPeriodOptions() {
    ...
    final year = now.year;
    final isSecondHalf = now.month >= 7;
  ...
  String _formatEmploymentPeriod(String? value) {
    if (value == null) return '-';
    if (value == 'asap') return '즉시 가능';
    if (value == 'unknown') return '잘 모르겠어요';
    
    final parts = value.split('_');
    if (parts.length == 2) {
      final year = parts[0];
      final term = parts[1] == 'first' ? '상반기' : '하반기';
      return '$year $term';
    }
    return value;
  }
                              ...
                              children: [
                                Expanded(
                                  child: ElevatedButton(
                                    ...
                                    child: const Text('이전', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black87)),
                                  ),
                                ),
      ...
      child: Column(
        ...
        children: [
          AnimatedContainer(
            ...
            margin: EdgeInsets.only(top: _showNameInput ? 0 : MediaQuery.of(context).size.height * 0.22),
            ...
            child: Row(
              ...
              children: [
                AnimatedDefaultTextStyle(
                  duration: const Duration(milliseconds: 800),
                  curve: Curves.easeInOutCubic,
                  style: TextStyle(fontSize: _showNameInput ? 28 : 38, fontWeight: FontWeight.bold, color: Colors.black87),
          ...
          _buildAnimatedSection(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('사용하실 닉네임을 입력해주세요', style: TextStyle(fontSize: 16, color: Colors.black87, fontWeight: FontWeight.bold)),
          ...
          _buildAnimatedSection(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('현재 재학 중인 학년을 선택해주세요', style: TextStyle(fontSize: 16, color: Colors.black87, fontWeight: FontWeight.bold)),
                    ...
                    return Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text('$grade학년', style: TextStyle(color: isSelected ? Colors.white : Colors.black87, fontWeight: FontWeight.bold)),
                          ),
                        ),
                      ),
                    );
            ...
            child: Stack(
              ...
              children: [
                ...
                AnimatedOpacity(
                  ...
                  duration: const Duration(milliseconds: 800),
                  child: const Text('좋아요 🎉', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.black87)),
                ),
              ],
            ),
          ),
              ...
              child: Column(
                ...
                children: [
                  AnimatedContainer(
                    duration: const Duration(milliseconds: 800),
                    curve: Curves.easeInOutCubic,
                    margin: EdgeInsets.only(top: isReady ? 0 : MediaQuery.of(context).size.height * 0.22),
                    ...
                    child: AnimatedOpacity(
                      ...
                      child: Text.rich(
                        TextSpan(children: [
                          TextSpan(text: _nameController.text, style: TextStyle(color: primaryColor)),
                          TextSpan(text: isReady ? '님에 대해 좀 더 알려 주세요' : '님에 대해\n좀 더 알려 주세요', style: const TextStyle(color: Colors.black87)),
                        ]),
                        textAlign: isReady ? TextAlign.left : TextAlign.center,
                        style: TextStyle(fontSize: isReady ? 24 : 28, fontWeight: FontWeight.bold, height: 1.3),
                      ),
                    ),
                  ),
                  _buildAnimatedSection(
                    ...
                    child: Column(
                      ...
                      children: [
                        const SizedBox(height: 12),
                        const Text('희망하시는 직무를 선택해주세요', style: TextStyle(fontSize: 16, color: Colors.black87, fontWeight: FontWeight.bold)),
                        const SizedBox(height: 16),
                        Wrap(
                        ...
                        _buildAnimatedSection(
                          ...
                          child: Column(
                            ...
                            children: [
                              const SizedBox(height: 32),
                              const Text('선호하시는 기업 유형을 선택해주세요', style: TextStyle(fontSize: 16, color: Colors.black87, fontWeight: FontWeight.bold)),
                              const SizedBox(height: 16),
                              Column(
                                children: [
                              ...
                              const SizedBox(height: 32),
                              const Text('선호 근무 지역', style: TextStyle(fontSize: 16, color: Colors.black87, fontWeight: FontWeight.bold)),
                                ...
                                children: ['서울', '판교/분당', '경기', '인천', '부산', '대전', '무관'].map((region) {
                                  ...
                                  return GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(region, style: TextStyle(color: isSelected ? Colors.white : Colors.black87, fontWeight: FontWeight.bold, fontSize: 13)),
                                    ),
                                  );
                                }).toList(),
                              ),
                              const SizedBox(height: 32),
                              const Text('희망 연봉', style: TextStyle(fontSize: 16, color: Colors.black87, fontWeight: FontWeight.bold)),
                              const SizedBox(height: 4),
                                ...
                                children: [
                                  ...
                                  return GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(item['label'] as String, style: TextStyle(color: isSelected ? Colors.white : Colors.black87, fontWeight: FontWeight.bold, fontSize: 13)),
                                    ),
                                  );
                                }).toList(),
                              ),
                              const SizedBox(height: 32),
                              const Text('취업 희망 시기', style: TextStyle(fontSize: 16, color: Colors.black87, fontWeight: FontWeight.bold)),
                              const SizedBox(height: 4),
                              ...
                              Wrap(
                                ...
                                children: _buildEmploymentPeriodOptions().map((item) {
                                  ...
                                  return GestureDetector(
                                    onTap: () => setState(() => _selectedEmploymentPeriod = isSelected ? null : item['value']),
                                    child: Container(
                                      padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 10),
                                      decoration: BoxDecoration(
                                        color: isSelected ? primaryColor : Colors.grey[50],
                                      ...
                                      child: Text(item['label']!, style: TextStyle(color: isSelected ? Colors.white : Colors.black87, fontWeight: FontWeight.bold, fontSize: 13)),
                                    ),
                                  );
                                }).toList(),
                              ),
  ...
  Widget _buildPage3(Color primaryColor) {
    ...
    final isAwardEntered = _isFieldValid(_awardController, _noAward);
    final showTechStack = isGpaEntered && isToeicEntered && isCertEntered && isProjectEntered && isInternEntered && isAwardEntered;
    ...
    return Stack(
      children: [
            ...
            child: Stack(
              ...
              children: [
                ...
                AnimatedOpacity(
                  ...
                  duration: const Duration(milliseconds: 800),
                  child: const Text('거의 다 왔어요 👏', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.black87)),
                ),
              ],
            ),
          ),
        if (_page3AnimState >= 2)
          Scrollbar(
            controller: _page3Scroll,
            thumbVisibility: showTechStack,
            child: SingleChildScrollView(
              controller: _page3Scroll,
              padding: const EdgeInsets.symmetric(horizontal: 24),
              child: Column(
                ...
                children: [
                  AnimatedContainer(
                    ...
                    child: AnimatedOpacity(
                      ...
                      child: Text.rich(
                        TextSpan(children: [
                          TextSpan(text: _nameController.text, style: TextStyle(color: primaryColor)),
                          TextSpan(text: isReady ? '님의 스펙을 알려주세요' : '님의\n스펙을 알려주세요', style: const TextStyle(color: Colors.black87)),
                        ]),
                        textAlign: isReady ? TextAlign.left : TextAlign.center,
                        style: TextStyle(fontSize: isReady ? 24 : 28, fontWeight: FontWeight.bold, height: 1.3),
                      ),
                  ...
                  _buildAnimatedSection(
                    ...
                    child: Column(
                      ...
                      children: [
                        const SizedBox(height: 8),
                        const Text('순서대로 차근차근 입력해볼까요?', style: TextStyle(fontSize: 15, color: Colors.black54)),
                        const SizedBox(height: 32),
                        _buildGpaInput(primaryColor),
                        _buildAnimatedSection(
                          isVisible: isGpaEntered,
                          child: _buildOptionalSpecInput(label: '토익 점수', icon: Icons.language, hint: '예: 820', controller: _toeicController, focusNode: _toeicFocus, isChecked: _noToeic, primaryColor: primaryColor, onCheckChanged: (val) { setState(() { _noToeic = val ?? false; if (_noToeic) _toeicController.clear(); }); }),
                        ),
                        _buildAnimatedSection(
                          isVisible: isGpaEntered && isToeicEntered,
                          child: _buildOptionalSpecInput(label: '자격증', icon: Icons.workspace_premium, hint: '취득한 자격증 수', controller: _certController, focusNode: _certFocus, isChecked: _noCert, primaryColor: primaryColor, onCheckChanged: (val) { setState(() { _noCert = val ?? false; if (_noCert) _certController.clear(); }); }),
                        ),
                        _buildAnimatedSection(
                          isVisible: isGpaEntered && isToeicEntered && isCertEntered,
                          child: _buildOptionalSpecInput(label: '프로젝트 경험', icon: Icons.computer, hint: '진행한 프로젝트 수', controller: _projectController, focusNode: _projectFocus, isChecked: _noProject, primaryColor: primaryColor, onCheckChanged: (val) { setState(() { _noProject = val ?? false; if (_noProject) _projectController.clear(); }); }),
                        ),
                        _buildAnimatedSection(
                          isVisible: isGpaEntered && isToeicEntered && isCertEntered && isProjectEntered,
                          child: _buildOptionalSpecInput(label: '인턴 경험', icon: Icons.business_center_outlined, hint: '인턴 경험 횟수', controller: _internController, focusNode: _internFocus, isChecked: _noIntern, primaryColor: primaryColor, onCheckChanged: (val) { setState(() { _noIntern = val ?? false; if (_noIntern) _internController.clear(); }); }),
                        ),
                        _buildAnimatedSection(
                          isVisible: isGpaEntered && isToeicEntered && isCertEntered && isProjectEntered && isInternEntered,
                          child: _buildOptionalSpecInput(label: '수상 경력', icon: Icons.emoji_events_outlined, hint: '수상 횟수', controller: _awardController, focusNode: _awardFocus, isChecked: _noAward, primaryColor: primaryColor, onCheckChanged: (val) { setState(() { _noAward = val ?? false; if (_noAward) _awardController.clear(); }); }),
                        ),
                        _buildAnimatedSection(
                          isVisible: showTechStack, // 💡 조건 변수 재활용
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const SizedBox(height: 8),
  ...
  Widget _buildGpaInput(Color primaryColor) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: isFocused ? primaryColor : Colors.grey[200]!, width: isFocused ? 1.5 : 1.0),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(children: [
            ...
            const Text('평점', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.black87)),
          ]),
          const SizedBox(height: 16),
          TextField(
  ...
  Widget _buildOptionalSpecInput({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(20),
        border: Border.all(color: isChecked ? Colors.grey[200]! : (isFocused ? primaryColor : Colors.grey[200]!), width: isFocused ? 1.5 : 1.0),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            ...
            children: [
              Row(children: [
                ...
                const SizedBox(width: 8),
                Text(label, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: isChecked ? Colors.grey[400] : Colors.black87)),
              ]),
              GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(20),
                    border: Border.all(color: isChecked ? primaryColor.withOpacity(0.3) : Colors.transparent),
                  ),
                  child: Row(children: [
                    Icon(Icons.check, size: 14, color: isChecked ? primaryColor : Colors.grey[500]),
                    const SizedBox(width: 4),
                    Text('없음', style: TextStyle(color: isChecked ? primaryColor : Colors.grey[600], fontSize: 13, fontWeight: isChecked ? FontWeight.bold : FontWeight.w500)),
                  ]),
                ),
              ),
            ],
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(color: Colors.grey[400]),
              filled: true, fillColor: isChecked ? Colors.grey[100] : Colors.grey[50],
              contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    AnimatedDefaultTextStyle(
                      duration: const Duration(milliseconds: 800),
                      curve: Curves.easeInOutCubic,
                      style: TextStyle(fontSize: isReady ? 28 : 38, fontWeight: FontWeight.bold, color: Colors.black87),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildSummaryRow('취업 시기', _formatEmploymentPeriod(_selectedEmploymentPeriod)),
                          Divider(height: 32, color: Colors.grey[300]),
                          _buildSummaryRow('학점', _gpaController.text.isEmpty ? '-' : '${_gpaController.text} / 4.5'),
                          _buildSummaryRow('토익', _noToeic ? '없음' : (_toeicController.text.isEmpty ? '-' : '${_toeicController.text}점')),
                          _buildSummaryRow('자격증', _noCert ? '없음' : (_certController.text.isEmpty ? '-' : '${_certController.text}개')),
                          _buildSummaryRow('프로젝트', _noProject ? '없음' : (_projectController.text.isEmpty ? '-' : '${_projectController.text}개')),
                          _buildSummaryRow('인턴', _noIntern ? '없음' : (_internController.text.isEmpty ? '-' : '${_internController.text}회')),
                          _buildSummaryRow('수상', _noAward ? '없음' : (_awardController.text.isEmpty ? '-' : '${_awardController.text}회')),
